try {
    // Select the element
    var element = document.querySelector('body > div.container > div.qbe-content > div:nth-child(2) > div.col-sm-7 > div.visible-xs');
    
    // Change the inner HTML
    element.innerHTML = '<div class="visible-xs" style="width:100%;"><div id="feefo-service-review-carousel-widgetId" class="feefo-review-carousel-widget-service"></div></div>';
        ...
        window.dataLayer.push({
            event: 'standard',
            eventCategory: 'error',
            eventAction: 'optimize test - 118 Variant 2',
            eventLabel: error,
            nonInteraction: true,
        });
    }